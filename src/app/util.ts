...
import { z } from 'zod';
const jsonString = '{"date": "09/09/2024","price": 300.00,"description": "Indoor plants: Bluncorn and Purple Queen","category": "other"}';
